#include <depthai_bridge/ImgDetectionConverterRoboflow.hpp>
#include <cstdio>
...
ImgDetectionConverterRoboflow::ImgDetectionConverterRoboflow(std::string frameName, int width, int height, bool normalized)
...
#endif
std::cout << "ImgDetectionConverterRoboflow::ImgDetectionConverterRoboflow" << std::endl;

}

void ImgDetectionConverterRoboflow::toRosMsg(std::shared_ptr<dai::ImgDetections> inNetData, std::deque<VisionMsgs::Detection2DArray>& opDetectionMsgs) {
    // setting the header
    std::cout << "ImgDetectionConverterRoboflow::toRosMsg" << std::endl;
    if(inNetData == NULL){
      std::cout << "ImgDetectionConverterRoboflow::toRosMsg: inNetData = NULL" << std::endl;
      return;
    }
    #if 1
...
Detection2DArrayPtr ImgDetectionConverterRoboflow::toRosMsgPtr(std::shared_ptr<dai::ImgDetections> inNetData) {
